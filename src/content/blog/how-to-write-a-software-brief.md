...
category: 'Experience'
author: 'Chris'
tags: [project management, discovery, websites, mobile apps]
---
...
- Who they are (role, context, level of technical comfort)
- What they're trying to do
- Where they'll use the product (desktop in an office? phone on a building site? offline in a warehouse?)
- Roughly how many of them there are
...
- What system (CRM, accounting platform, internal database, third-party API)
- Whether the API exists and is documented
- Who controls it (you, a partner, a vendor)
...
- **Decision-makers**: who needs to approve what, and how quickly can they do so?
- **Existing assets**: do you have brand guidelines, a design system, content, photography?
- **Content**: who's writing the words that go inside the product?
- **Hosting and accounts**: do you have an AWS account, a Google Play account, an Apple Developer account? If not, who's setting them up and in whose name?
- **Ongoing ownership**: who'll own this internally after launch? They should be involved in the project from day one, not handed it on launch day.
